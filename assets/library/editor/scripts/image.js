...
$(document).ready(function(){
    ...
    myDropzone.on("success", function(file, response) {
        ...
        if(success_file==total_file) {
            if(success_file==1) {
                ...
                window.location.href = '/admin/editor/image?&tab=3';
            }
    ...
    $.fn.editable.defaults.url = '/admin/editor/image';
    ...
    $('.tab_btn .btn').click(function(){
        ...
        if(id=='#tab-2' || id=='#tab-3') {
            if($('.dz-image-preview').length>0) {
                ...
                if(is_done) {window.location.href = '/admin/editor/image?&tab=3'; return true;}
            }
        }
