...
$(document).ready(function () {
    ...
    $(".nav_radio input[type=radio]").change(function () {
        ...
        if (val == "left") {
            ...
            $(".quote-inner-box").removeClass("flleft");
            $(".quote-inner-box").removeClass("flright");
            $(".quote-inner-box").css({
                width: "100%",
            });
        } else if (val == "right") {
    ...
    $(".nav_radio_box input[name=type_border]").change(function () {
        ...
        if (val == "border") {
            ...
            $(".quote-inner blockquote").css({
                background:
                    "url(https://media.lyluanchinhtrivatruyenthong.vn/uploads/images/quote.png) no-repeat",
